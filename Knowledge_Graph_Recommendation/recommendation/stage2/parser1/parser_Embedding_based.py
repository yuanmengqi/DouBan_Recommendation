...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='add',
                        help='Specify the method to combine CF and KG from {add, concat, minus, dot}.')
    ...
    save_dir = 'trained_model/{}/Embedding_based/dim{}_lr{}_l2{}_{}/{}'.format(
        args.data_name, args.embed_dim, args.lr, args.cf_l2loss_lambda, args.KG_embedding_type, args.method)
